...
$(function(){
    ...
    // 商品轮播组件列表名称长度计算
    $('.attr-content-goods-swiper').each(function(idx,item){
        var goods_swiper_title = $(item).find(".attr-content-goods-swiper-title").val();
        if(goods_swiper_title != undefined){
            $(item).find('.goods-swiper-title-length').html(goods_swiper_title.length);
        }
    });
    // 导航组件文字内容长度计算
    ...
    // 商品轮播组件
    $(".component-goods-swiper").click(function(event){
        var hidden_cats_id = $('.hidden-cats-id').val();
        componentRemoveClasses(1);
        var goods_swiper_num = 0;
        var goods_swiper_num_arr = [];
        $(".effect-goods-swiper").each(function(idx, item) {
            goods_swiper_num = parseInt($(item).attr('goods_swiper_num'));
            goods_swiper_num_arr.push(goods_swiper_num);
        });
        if(goods_swiper_num_arr.length>0){
            goods_swiper_num = Math.max.apply(null,goods_swiper_num_arr)+1;
        }else{
            goods_swiper_num = 1;
        }
        var goods_swiper_class_name = "goods_swiper"+goods_swiper_num;
        var goods_swiper_attr_class_name = "goods_swiper_attr"+goods_swiper_num;
        $(".effect-content").append("<div class='el-relative'><div class='interval'></div><div class='effect-goods-swiper "+goods_swiper_class_name+"' goods_swiper_num="+goods_swiper_num+" ><input type='hidden' class='sort' value='0'/><input type='hidden' class='sort-name' value='goods_swiper'/><div class='wst-flex-row wst-center goods-swiper-title' ><div class='goods-swiper-title-text goods-swiper-title-text_bg wst-flex-row wst-center'>"+WST.lang('shopcustompage_marketing_title')+"</div></div><div class='wst-flex-row'><div class='goods' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/good_01.jpg' alt=''  /><div class='goods-info' ><div class='wst-flex-column wst-center' ><p class='goods-price red '>"+WST.lang('currency_symbol')+"99.00</p></div></div></div><div class='goods' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/good_02.jpg' alt=''  /><div class='goods-info' ><div class='wst-flex-column wst-center' ><p class='goods-price red '>"+WST.lang('currency_symbol')+"99.00</p></div></div></div><div class='goods' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/good_03.jpg' alt=''  /><div class='goods-info' ><div class='wst-flex-column wst-center' ><p class='goods-price red '>"+WST.lang('currency_symbol')+"99.00</p></div></div></div></div><div class='btn-del' onclick='delGoodsSwiperBtn(this)'>"+WST.lang('shopcustompage_del')+"</div></div><div class='border-absolute effect-active select' onclick='addGoodsSwiperClassActive(this)' onmouseover='addClassActive(this)' onmouseout='removeClassActive(this)'></div></div>");
        $(".attr-title").html(WST.lang("shopcustompage_component_goods_swiper"));
        hideComponentAttrContent(1);
        $(".attr-content").append("<div class='attr-content-goods-swiper "+goods_swiper_attr_class_name+"' goods_swiper_num="+goods_swiper_num+"><div class='attr-content-goods-group-item' ><label class='d-label'>"+WST.lang('shopcustompage_goods_group_title')+"</label><input type='text' value='"+WST.lang('shopcustompage_marketing_title')+"' class='attr-content-goods-swiper-title' onkeyup='setGoodsSwiperTitle(this)'/><span class='goods-swiper-title-tip'><span class='goods-swiper-title-length'>4</span>/4</span></div><div class='attr-content-goods-group-item' ><label class='d-label'>"+WST.lang('shopcustompage_goods_swiper_title_bg')+"</label><input type='radio' value='1' name='goods_swiper_title_bg"+goods_swiper_num+"' id='goods-swiper-title-bg-one"+goods_swiper_num+"' onclick='changeGoodsSwiperTitleBg(this)'  checked /><label for='goods-swiper-title-bg-one"+goods_swiper_num+"'>"+WST.lang('shopcustompage_image')+"1</label><input type='radio' value='2' name='goods_swiper_title_bg"+goods_swiper_num+"' id='goods-swiper-title-bg-two"+goods_swiper_num+"' onclick='changeGoodsSwiperTitleBg(this)'  /><label for='goods-swiper-title-bg-two"+goods_swiper_num+"'>"+WST.lang('shopcustompage_image')+"2</label></div><div class='attr-content-goods-swiper-item' ><label class='d-label'>"+WST.lang('shopcustompage_goods_num')+"</label><input type='radio' value='4' name='goods_swiper_goods_num"+goods_swiper_num+"' id='goods-swiper-goods-num-four"+goods_swiper_num+"' onclick='changeGoodsSwiperGoodsNum(this)'  checked /><label for='goods-swiper-goods-num-four"+goods_swiper_num+"'>4"+WST.lang('shopcustompage_goods_unit')+"</label><input type='radio' value='6' name='goods_swiper_goods_num"+goods_swiper_num+"' id='goods-swiper-goods-num-six"+goods_swiper_num+"' onclick='changeGoodsSwiperGoodsNum(this)'  /><label for='goods-swiper-goods-num-six"+goods_swiper_num+"'>6"+WST.lang('shopcustompage_goods_unit')+"</label><input type='radio' value='8' name='goods_swiper_goods_num"+goods_swiper_num+"' id='goods-swiper-goods-num-eight"+goods_swiper_num+"' onclick='changeGoodsSwiperGoodsNum(this)'  /><label for='goods-swiper-goods-num-eight"+goods_swiper_num+"'>8"+WST.lang('shopcustompage_goods_unit')+"</label></div><div class='goods-num-tips'>"+WST.lang('shopcustompage_goods_num_tips')+"</div><div class='attr-content-goods-swiper-item' ><label class='d-label'>"+WST.lang('shopcustompage_goods_sort')+"</label><select name='goods-swiper-order"+goods_swiper_num+"' onchange='changeGoodsSwiperOrder(this)'><option value='1' >"+WST.lang('shopcustompage_goods_group_order1')+"</option><option value='2' >"+WST.lang('shopcustompage_goods_group_order2')+"</option><option value='3' >"+WST.lang('shopcustompage_goods_group_order3')+"</option><option value='4' >"+WST.lang('shopcustompage_goods_group_order4')+"</option><option value='5' >"+WST.lang('shopcustompage_goods_group_order5')+"</option><option value='6' >"+WST.lang('shopcustompage_goods_group_order6')+"</option><option value='7' >"+WST.lang('shopcustompage_goods_group_order7')+"</option><option value='8' >"+WST.lang('shopcustompage_goods_group_order8')+"</option></select></div><div class='attr-content-goods-swiper-item-column' ><label class='d-label'>"+WST.lang('shopcustompage_select_goods')+"</label><input type='radio' value='1' name='goods-swiper-goods-select"+goods_swiper_num+"' id='goods-swiper-goods-select-condition1' onclick='changeGoodsSwiperGoodsSelect(this)'  checked /><label for='goods-swiper-goods-select-condition"+goods_swiper_num+"'>"+WST.lang('shopcustompage_condition_select')+"</label><input type='radio' value='2' name='goods-swiper-goods-select"+goods_swiper_num+"' id='goods-swiper-goods-select-manual"+goods_swiper_num+"' onclick='changeGoodsSwiperGoodsSelect(this)'  /><label for='goods-swiper-goods-select-manual1'>"+WST.lang('shopcustompage_manual_add')+"</label><input type='hidden' class='goods-select-ids-value' value='' ><input type='hidden' class='goods-select-cats-id-value' value="+hidden_cats_id+" ><input type='hidden' class='goods-tag-value' value='' /><input type='hidden' class='goods-min-price-value' value='' /><input type='hidden' class='goods-max-price-value' value='' /></div><input type='hidden' class='goods-swiper-bg-color' value='#ffffff' /><input type='hidden' class='goods-swiper-goods-nums' value='4' /><input type='hidden' class='goods-swiper-order' value='1' /><input type='hidden' class='goods-swiper-title-bg' value='1' /></div>");
        $(".attr-content-goods-swiper").each(function(idx, item) {
            if($(item).hasClass("goods_swiper_attr"+goods_swiper_num)){
                $(item).show();
            }else{
                $(item).hide();
            }
    ...
    $(".component-nav").click(function(event){
        ...
        $(".effect-content").append("<div class='el-relative'><div class='interval'></div><div class='effect-nav "+nav_class_name+"' nav_num="+nav_num+" ><input type='hidden' class='sort' value='0'/><input type='hidden' class='sort-name' value='nav'/><div class='navs' nav_item='1'><img class='nav-style-roundness' src='"+base_url+"/upload/shopcustompagedecoration/base/nav_01.png' alt=''/><div class='navs-info'><p>"+WST.lang('shopcustompage_bottom_text')+"</p></div></div><div class='navs' nav_item='2'><img class='nav-style-roundness' src='"+base_url+"/upload/shopcustompagedecoration/base/nav_02.png' alt=''/><div class='navs-info'><p>"+WST.lang('shopcustompage_bottom_text')+"</p></div></div><div class='navs' nav_item='3'><img class='nav-style-roundness' src='"+base_url+"/upload/shopcustompagedecoration/base/nav_03.png' alt=''/><div class='navs-info'><p>"+WST.lang('shopcustompage_bottom_text')+"</p></div></div><div class='navs' nav_item='4'><img class='nav-style-roundness' src='"+base_url+"/upload/shopcustompagedecoration/base/nav_04.png' alt=''/><div class='navs-info'><p>"+WST.lang('shopcustompage_bottom_text')+"</p></div></div><div class='btn-del' onclick='delNavBtn(this)'>"+WST.lang('shopcustompage_del')+"</div></div><div class='border-absolute effect-active select' onclick='addNavClassActive(this)' onmouseover='addClassActive(this)' onmouseout='removeClassActive(this)'></div></div>");
        $(".attr-title").html(WST.lang("shopcustompage_component_nav"));
        hideComponentAttrContent(1);
        $(".attr-content").append("<div class='attr-content-nav "+nav_attr_class_name+"' nav_num="+nav_num+"><div class='attr-content-nav-item' ><label class='d-label'>"+WST.lang('shopcustompage_background_color')+"</label><div class='select-component-item-color nav-select-bg-color'></div></div><div class='attr-content-nav-item' ><label class='d-label'>"+WST.lang('shopcustompage_each_row_num')+"</label><input type='radio' value='1' name='nav-count"+nav_num+"'  id='n-three' onclick='changeNavCount(this)' /><label for='n-three'>3"+WST.lang('shopcustompage_goods_unit')+"</label><input type='radio' value='2' name='nav-count"+nav_num+"' id='n-four' onclick='changeNavCount(this)' checked /><label for='n-four'>4"+WST.lang('shopcustompage_goods_unit')+"</label><input type='radio' value='3' name='nav-count"+nav_num+"' id='n-five' onclick='changeNavCount(this)' /><label for='n-five'>5"+WST.lang('shopcustompage_goods_unit')+"</label></div><div class='attr-content-nav-item'><label class='d-label'>"+WST.lang('shopcustompage_style_select')+"</label><input type='radio' value='1' name='nav-style"+nav_num+"' id='n-square"+nav_num+"' onclick='changeNavStyle(this)' /><label for='n-square"+nav_num+"' class='d-a-label'>"+WST.lang('shopcustompage_square')+"</label><input type='radio' value='2' name='nav-style"+nav_num+"' id='n-roundness"+nav_num+"' onclick='changeNavStyle(this)' checked /><label for='n-roundness"+nav_num+"' class='d-a-label'>"+WST.lang('shopcustompage_roundness')+"</label></div><div class='attr-content-nav-item-group' nav_item='1'><div class='attr-content-nav-img' img_url='/upload/shopcustompagedecoration/base/nav_01.png'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='nav-picker' id='nav-picker-"+nav_num+"-1'><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_01.png'/></div><div class='image-tips'>"+WST.lang('shopcustompage_nav_image_tips')+"</div></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_content')+"</label><input type='text' value='"+WST.lang('shopcustompage_bottom_text')+"' class='attr-content-nav-text' onkeyup='setNavItemTitle(this)' /><span class='nav-text-tip'><span class='nav-text-length'>4</span>/4</span></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_color')+"</label><div class='select-component-item-color nav-select-text-color' style='background:#666666;'></div><input type='hidden' class='attr-content-nav-text-color' value='#666666' /></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_link_address')+"</label><input type='text' value='' class='attr-content-nav-link' /></div><div class='attr-btn-del' onclick='delNavItemBtn(this)'>X</div></div><div class='attr-content-nav-item-group' nav_item='2'><div class='attr-content-nav-img' img_url='/upload/shopcustompagedecoration/base/nav_02.png'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='nav-picker' id='nav-picker-"+nav_num+"-2' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_02.png'/></div><div class='image-tips'>"+WST.lang('shopcustompage_nav_image_tips')+"</div></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_content')+"</label><input type='text' value='"+WST.lang('shopcustompage_bottom_text')+"' class='attr-content-nav-text' onkeyup='setNavItemTitle(this)' /><span class='nav-text-tip'><span class='nav-text-length'>4</span>/4</span></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_color')+"</label><div class='select-component-item-color nav-select-text-color' style='background:#666666;'></div><input type='hidden' class='attr-content-nav-text-color' value='#666666' /></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_link_address')+"</label><input type='text' value='' class='attr-content-nav-link' /></div><div class='attr-btn-del' onclick='delNavItemBtn(this)'>X</div></div><div class='attr-content-nav-item-group' nav_item='3'><div class='attr-content-nav-img' img_url='/upload/shopcustompagedecoration/base/nav_03.png'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='nav-picker' id='nav-picker-"+nav_num+"-3' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_03.png'/></div><div class='image-tips'>"+WST.lang('shopcustompage_nav_image_tips')+"</div></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_content')+"</label><input type='text' value='"+WST.lang('shopcustompage_bottom_text')+"' class='attr-content-nav-text' onkeyup='setNavItemTitle(this)' /><span class='nav-text-tip'><span class='nav-text-length'>4</span>/4</span></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_color')+"</label><div class='select-component-item-color nav-select-text-color' style='background:#666666;'></div><input type='hidden' class='attr-content-nav-text-color' value='#666666' /></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_link_address')+"</label><input type='text' value='' class='attr-content-nav-link' /></div><div class='attr-btn-del' onclick='delNavItemBtn(this)'>X</div></div><div class='attr-content-nav-item-group' nav_item='4'><div class='attr-content-nav-img' img_url='/upload/shopcustompagedecoration/base/nav_04.png'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='nav-picker' id='nav-picker-"+nav_num+"-4'><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_04.png'/></div><div class='image-tips'>"+WST.lang('shopcustompage_nav_image_tips')+"</div></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_content')+"</label><input type='text' value='"+WST.lang('shopcustompage_bottom_text')+"' class='attr-content-nav-text' onkeyup='setNavItemTitle(this)' /><span class='nav-text-tip'><span class='nav-text-length'>4</span>/4</span></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_color')+"</label><div class='select-component-item-color nav-select-text-color'  style='background:#666666;'></div><input type='hidden' class='attr-content-nav-text-color' value='#666666' /></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_link_address')+"</label><input type='text' value='' class='attr-content-nav-link' /></div><div class='attr-btn-del' onclick='delNavItemBtn(this)'>X</div></div><div class='attr-content-nav-item-add' onclick='addNavItem(this)'>"+WST.lang('shopcustompage_add_one')+"</div><input type='hidden' class='nav-bg-color' value='#ffffff' /><input type='hidden' class='nav-count' value=2 /><input type='hidden' class='nav-style' value=2 /></div>");
        // nav上传图片开始
        WST.upload({
    ...
    $(".component-search").click(function(){
        ...
        $(".effect-content").append("<div class='el-relative'><div class='interval'></div><div class='effect-search "+search_class_name+"' search_num="+search_num+" ><input type='hidden' class='sort' value='0'/><input type='hidden' class='sort-name' value='search'/><div class='search-info'><i class='fa fa-search'></i><p>"+WST.lang('shopcustompage_input_keyword_to_search')+"</p></div><div class='btn-del' onclick='delSearchBtn(this)'>"+WST.lang('shopcustompage_del')+"</div></div><div class='border-absolute effect-active select' onclick='addSearchClassActive(this)' onmouseover='addClassActive(this)' onmouseout='removeClassActive(this)'></div></div>");
        $(".attr-title").html(WST.lang("shopcustompage_component_search"));
        hideComponentAttrContent(1);
        $(".attr-content").append("<div class='attr-content-search "+search_attr_class_name+"' search_num="+search_num+" ><div class='attr-content-search-item'><div class='attr-content-search-item-title'><label class='d-label'>"+WST.lang('shopcustompage_prompt_text')+"</label></div><div class='attr-content-search-item-content'><input type='text' value='"+WST.lang('shopcustompage_input_keyword_to_search')+"' class='attr-content-search-text' onkeyup='setSearchText(this)' /></div></div><div class='attr-content-search-item'><div class='attr-content-search-item-title'><label class='d-label'>"+WST.lang('shopcustompage_search_style')+"</label></div><div class='attr-content-search-item-content'><input type='radio' value='1' checked name='search-class"+search_num+"'  id='s-square' onclick='changeSearchClass(this)' /><label for='s-square'>"+WST.lang('shopcustompage_search_class1')+"</label><input type='radio' value='2' name='search-class"+search_num+"' id='s-circular' onclick='changeSearchClass(this)' /><label for='s-circular'>"+WST.lang('shopcustompage_search_class2')+"</label><input type='radio' value='3' name='search-class"+search_num+"' id='s-arc' onclick='changeSearchClass(this)' /><label for='s-arc'>"+WST.lang('shopcustompage_search_class3')+"</label></div></div><div class='attr-content-search-item'><div class='attr-content-search-item-title'><label class='d-label'>"+WST.lang('shopcustompage_text_alignment')+"</label></div><div class='attr-content-search-item-content'><input type='radio' value='1' checked name='search-text-alignment"+search_num+"'  id='s-left' onclick='changeSearchTextAlignment(this)' /><label for='s-left'>"+WST.lang('shopcustompage_alignment_left')+"</label><input type='radio' value='2' name='search-text-alignment"+search_num+"' id='s-center' onclick='changeSearchTextAlignment(this)' /><label for='s-center'>"+WST.lang('shopcustompage_alignment_center')+"</label><input type='radio' value='3' name='search-text-alignment"+search_num+"' id='s-right' onclick='changeSearchTextAlignment(this)' /><label for='s-right'>"+WST.lang('shopcustompage_alignment_right')+"</label></div></div><input type='hidden' class='attr-content-search-class' value='1' /><input type='hidden' class='attr-content-search-text-alignment' value='1' /></div>");
    ...
    $(".component-coupon").click(function(event){
        ...
        hideComponentAttrContent(1);
        $(".attr-content").append("<div class='attr-content-coupon "+coupon_attr_class_name+"' coupon_num="+coupon_num+"><div class='attr-content-coupon-item'><label class='d-label'>"+WST.lang('shopcustompage_coupon_style')+"</label><input type='radio' value='1' name='coupon-style"+coupon_num+"'  id='c-style-one"+coupon_num+"' onclick='changeCouponStyle(this)'  checked /><label for='c-style-one"+coupon_num+"'>"+WST.lang('shopcustompage_style1')+"</label><input type='radio' value='2' name='coupon-style"+coupon_num+"' id='c-style-two"+coupon_num+"' onclick='changeCouponStyle(this)' /><label for='c-style-two"+coupon_num+"'>"+WST.lang('shopcustompage_style2')+"</label></div><div class='attr-content-coupon-item'><label class='d-label'>"+WST.lang('shopcustompage_vertical_padding')+"</label><div class='attr-content-coupon-item-content'><input type='hidden' class='coupon-padding-range-slider'  value='0' onchange='changeCouponPadding(this)'/><span class='coupon-vertical-padding-value'>10</span><span class='pixel'>px ("+WST.lang('shopcustompage_px')+")</span></div></div><div class='attr-content-coupon-item' ><label class='d-label'>"+WST.lang('shopcustompage_background_color')+"</label><div class='select-component-item-color coupon-select-bg-color'></div></div><div class='attr-content-coupon-item'><label class='d-label'>"+WST.lang('shopcustompage_add_coupon')+"</label><div class='add-coupon' onclick='addCoupons(this)'>+ "+WST.lang('shopcustompage_add_coupon')+"</div></div><div class='coupon-tips'>"+WST.lang('shopcustompage_coupon_tips1')+"</div><div class='coupon-tips'>"+WST.lang('shopcustompage_coupon_tips2')+"</div><div class='coupon-tips red'>"+WST.lang('shopcustompage_coupon_tips3')+"</div><div class='coupon-tips red'>"+WST.lang('shopcustompage_coupon_tips4')+"</div><input type='hidden' class='coupon-vertical-padding' value='0'><input type='hidden' class='coupon-bg-color' value='#ffffff' /><input type='hidden' class='coupon-counts' value='2'><input type='hidden' class='coupon-style' value='1' /><input type='hidden' class='coupon-select-ids-value' value='' ></div>");
        $('.coupon-select-bg-color').colpick({
            layout:'hex',
            submit:1,
            colorScheme:'dark',
...
function hideComponentAttrContent(type){
    ...
    $(".attr-content-goods-swiper").hide();
...
function addSwiperItem(obj){
    ...
    $(obj).before("<div class='attr-content-swiper-item-img'><div class='attr-content-swiper-img' img_url='upload/shopcustompagedecoration/base/banner_01.jpg'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='banner-picker' id='banner-picker-"+swiper_num+"-"+swiper_img_num+"'><img src='"+base_url+"/upload/shopcustompagedecoration/base/banner_01.jpg'/></div><div class='image-tips'>"+WST.lang('shopcustompage_swiper_image_tips')+"</div></div><label class='d-label'>"+WST.lang('shopcustompage_link')+"</label><input type='text' value='' class='attr-content-swiper-link' /><div class='attr-btn-del' onclick='delSwiperItemBtn(this)'>X</div></div>");
    WST.upload({
    ...
    if(columns_value == 2){
        ...
        $(".effect-goods-group").each(function(idx, item) {
            if($(item).hasClass("goods_group"+goods_group_num)){
                ...
                if(goods_columns == 1){
                    $(item).find('.goods').parent().append("<div class='goods'><img src='"+base_url+"/upload/shopcustompagedecoration/base/good_02.jpg' alt=''/><div class='goods-info'><div><p class='goods-name'>"+WST.lang('shopcustompage_here_show_goods_name')+"</p><p class='goods-price red'>"+WST.lang('currency_symbol')+"99.00</p><div class='wst-flex-row wst-jsb'><p class='goods-praise-rate'>100%</p><p class='goods-sale-num'>"+WST.lang('shopcustompage_sale_num')+":99</p></div></div></div></div>");
                }
            }
        });
...
// 商品轮播组件方法开始
function delGoodsSwiperBtn(obj){
    var goods_swiper_num = $(obj).parent().attr("goods_swiper_num");
    layer.confirm(WST.lang('shopcustompage_confirm_del'), {icon: 3, title:WST.lang('shopcustompage_info')}, function(index){
        $(".effect-goods-swiper").each(function(idx, item) {
            if($(item).hasClass("goods_swiper"+goods_swiper_num)){
                $(item).parent().remove();
            }
        });
        $(".attr-content-goods-swiper").each(function(idx, item) {
...
function addGoodsSwiperClassActive(obj){
    var goods_swiper_num = $(obj).parent().find(".effect-goods-swiper").attr("goods_swiper_num");
    componentRemoveClasses(1);
    $(obj).addClass("effect-active");
    $(obj).addClass("select");
...
function setGoodsSwiperTitle(obj){
    var goods_swiper_num = $(obj).parent().parent().attr("goods_swiper_num");
    var goods_swiper_title = $(obj).val();
    var goods_swiper_title_length = goods_swiper_title.length;
    $(".effect-goods-swiper").each(function(idx, item) {
        if($(item).hasClass("goods_swiper"+goods_swiper_num)){
            if(goods_swiper_title.length>4){
                goods_swiper_title = goods_swiper_title.substr(0,4);
            }
            $(item).find(".goods-swiper-title-text").html(goods_swiper_title);
        }
    });
    $(".attr-content-goods-swiper").each(function(idx, item) {
        if($(item).hasClass("goods_swiper_attr"+goods_swiper_num)){
            if(goods_swiper_title_length > 4){
                $(item).find('.goods-swiper-title-length').html(4);
            }else{
                $(item).find('.goods-swiper-title-length').html(goods_swiper_title_length);
            }
        }
    });
}

function changeGoodsSwiperTitleBg(obj){
    var goods_swiper_num = $(obj).parent().parent().attr("goods_swiper_num");
    var goods_swiper_title_bg = $(obj).val();
    $(obj).parent().parent().find(".goods-swiper-title-bg").val(goods_swiper_title_bg);
    $(".effect-goods-swiper").each(function(idx, item) {
        if($(item).hasClass("goods_swiper"+goods_swiper_num)){
            if(goods_swiper_title_bg==1){
                $(item).find('.goods-swiper-title-text').removeClass('goods-swiper-title-text_bg2').addClass('goods-swiper-title-text_bg');
            }else{
                $(item).find('.goods-swiper-title-text').removeClass('goods-swiper-title-text_bg').addClass('goods-swiper-title-text_bg2');
            }
        }
    });
}

function changeGoodsSwiperGoodsNum(obj){
    var goods_num_value = $(obj).val();
    $(obj).parent().parent().find(".goods-swiper-goods-nums").val(goods_num_value);
}

function changeGoodsSwiperOrder(obj){
    var order = $(obj).val();
    $(obj).parent().parent().find(".goods-swiper-order").val(order);
}

function changeGoodsSwiperGoodsSelect(obj){
    var goods_select = $(obj).val();
    var goods_swiper_num = $(obj).parent().parent().attr("goods_swiper_num");
    if(goods_select == 1){
        // 条件选取
        ...
        var box = WST.open({title:WST.lang('shopcustompage_select_goods_by_condition'),type:1,content:$('#goodBox2'),area: ['80%', '80%'],offset:['10%','10%'],btn: [WST.lang('shopcustompage_confirm'),WST.lang('shopcustompage_cancel')],
            yes:function(){
                ...
                $(".attr-content-goods-swiper").each(function(idx, item) {
                    if($(item).attr('goods_swiper_num')==goods_swiper_num){
...
function addNavItem(obj){
    ...
    $(".effect-nav").each(function(idx, item) {
        if($(item).hasClass("nav"+nav_num)){
            ...
            $(item).find(".btn-del").before("<div class='navs' nav_item="+nav_item+"><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_01.png' alt=''/><div class='navs-info'><p>"+WST.lang('shopcustompage_bottom_text')+"</p></div></div>");
            if(nav_count == 1){
                // nav组件每行显示三个
    ...
    $(obj).before("<div class='attr-content-nav-item-group' nav_item="+nav_item+"><div class='attr-content-nav-img' img_url='/upload/shopcustompagedecoration/base/nav_01.png'><label class='d-label'>"+WST.lang('shopcustompage_image')+"</label><div class='nav-picker' id='nav-picker-"+nav_num+"-"+nav_img_num+"' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/nav_01.png'/></div><div class='image-tips'>"+WST.lang('shopcustompage_nav_image_tips')+"</div></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_content')+"</label><input type='text' value='"+WST.lang('shopcustompage_bottom_text')+"' class='attr-content-nav-text' onkeyup='setNavItemTitle(this)'  /><span class='nav-text-tip'><span class='nav-text-length'>4</span>/4</span></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_text_color')+"</label><div class='select-component-item-color nav-select-text-color' style='background:#666666;'></div><input type='hidden' class='attr-content-nav-text-color' value='#666666' /></div><div class='attr-content-nav-info'><label class='nav-label'>"+WST.lang('shopcustompage_link_address')+"</label><input type='text' value='' class='attr-content-nav-link' /></div><div class='attr-btn-del' onclick='delNavItemBtn(this)'>X</div></div>");
    WST.upload({
    ...
    var box = WST.open({title:WST.lang('shopcustompage_coupon_list')+"&nbsp;<span style='color:#ff0000;'>("+WST.lang('custompage_index_coupon_tips')+")</span>",type:1,content:$('#couponBox'),area: ['80%', '55%'],btn: [WST.lang('shopcustompage_confirm'),WST.lang('shopcustompage_cancel')],
        yes:function(){
            ...
            if(coupon_nums > coupon_limit){
                WST.msg(WST.lang('shopcustompage_coupon_num_error'),{time:1000,anim: 6});
                return;
            }
            if(coupon_style==1){
                if(coupon_nums < 3){
                    WST.msg(WST.lang('shopcustompage_at_least_select_three_coupon'),{time:1000,anim: 6});
                    return;
                }
            }else{
                if(coupon_nums < 2){
                    WST.msg(WST.lang('shopcustompage_at_least_select_two_coupon'),{time:1000,anim: 6});
                    return;
                }
            }
            $(".attr-content-coupon").each(function(idx, item) {
...
function addImageItem(obj){
    ...
    $(".effect-image").each(function(idx, item) {
        if($(item).hasClass("image"+image_num)){
            ...
            $(item).find(".images").append("<div class='images-item' style='"+style+"' ><img src='"+base_url+"/upload/shopcustompagedecoration/base/banner_01.jpg' alt='' image_item="+image_item+" /></div>");
        }
    });
    $(".attr-content-image").each(function(idx, item) {
...
function addNewClassActive(obj){
    ...
    $(".attr-title").html(WST.lang("shopcustompage_new"));
    hideComponentAttrContent(1);
    $(".attr-content-new").each(function(idx, item) {
        if($(item).hasClass("new_attr"+new_num)){
            $(item).show();
...
function submit(){
    ...
    // 商品轮播组件开始
    var goods_swiper_component = [];
    var goods_swiper_item_id = [];
    var goods_swiper_goods_nums = [];
    var goods_swiper_title = [];
    var goods_swiper_title_bg = [];
    var goods_swiper_goods_select = [];
    var goods_swiper_goods_select_ids = [];
    var goods_swiper_goods_select_cats_id = [];
    var goods_swiper_order = [];
    var goods_swiper_goods_tag = [];
    var goods_swiper_goods_min_price = [];
    var goods_swiper_goods_max_price = [];

    var goods_swiper_nums = [];
    $(".effect-goods-swiper").each(function(idx, item) {
        var goods_swiper_num = $(item).attr("goods_swiper_num");
        goods_swiper_nums.push(goods_swiper_num);
    });
    for(var i=0;i<goods_swiper_nums.length;i++){
        $(".attr-content-goods-swiper").each(function(idx, item) {
            if($(item).attr("goods_swiper_num") == goods_swiper_nums[i]){
                var goodsSwiperName = "goods_swiper"+$(item).attr("goods_swiper_num");
                goods_swiper_component.push(goodsSwiperName);
                var goodsSwiperTitle = $(item).find(".attr-content-goods-swiper-title").val();
                if(goodsSwiperTitle.length>4){
                    goodsSwiperTitle = goodsSwiperTitle.substr(0,4);
                }
                goods_swiper_title.push(goodsSwiperTitle);
                goods_swiper_title_bg.push($(item).find('.goods-swiper-title-bg').val());
                goods_swiper_goods_nums.push($(item).find(".goods-swiper-goods-nums").val());
                goods_swiper_order.push($(item).find(".goods-swiper-order").val());
                $(item).find("input[name^='goods-swiper-goods-select']").each(function(key,value){
                    if($(value).prop('checked')){
                        goods_swiper_goods_select.push($(value).val());
                    }
                });
                goods_swiper_goods_select_ids.push($(item).find('.goods-select-ids-value').val());
                goods_swiper_goods_select_cats_id.push($(item).find('.goods-select-cats-id-value').val());
                goods_swiper_goods_tag.push($(item).find('.goods-tag-value').val());
                goods_swiper_goods_min_price.push($(item).find('.goods-min-price-value').val());
                goods_swiper_goods_max_price.push($(item).find('.goods-max-price-value').val());
            }
        });
        $(".attr-content-goods-swiper").each(function(idx, item) {
            if($(item).attr("goods_swiper_num") == goods_swiper_nums[i]){
                goods_swiper_item_id.push($(item).find(".goods-swiper-item-id").val());
            }
        });
    }
    params.goods_swiper_component = goods_swiper_component;
    params.goods_swiper_goods_nums = goods_swiper_goods_nums;
    params.goods_swiper_title = goods_swiper_title;
    params.goods_swiper_title_bg = goods_swiper_title_bg;
    params.goods_swiper_goods_select = goods_swiper_goods_select;
    params.goods_swiper_goods_select_ids = goods_swiper_goods_select_ids;
    params.goods_swiper_goods_select_cats_id = goods_swiper_goods_select_cats_id;
    params.goods_swiper_goods_tag = goods_swiper_goods_tag;
    params.goods_swiper_goods_max_price = goods_swiper_goods_max_price;
    params.goods_swiper_goods_min_price = goods_swiper_goods_min_price;
    params.goods_swiper_order = goods_swiper_order;
    params.goods_swiper_item_id = goods_swiper_item_id;
    //console.log("params:",params);return;
    // 商品轮播组件结束
        ...
        $(".attr-content-coupon").each(function(idx, item) {
            if($(item).attr("coupon_num") == coupons[i]){
                ...
                if(coupon_select_ids_value == ''){
                    WST.msg(WST.lang('shopcustompage_no_add_coupon'),{time:1000,anim: 6});
                    coupon_flag = true;
                }
                var coupon_limit = 0;
