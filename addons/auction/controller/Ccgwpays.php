...
class Ccgwpays extends Controller{
	...
	public function initialize() {
		...
		$this->payConfig['notifyurl'] = addon_url("auction://ccgwpays/ccgwNotify","",true,true);
	...
	public function getCcgwPaysURL(){
		...
		$data["url"] = addon_url('auction://ccgwpays/createQrcode',array("pkey"=>WSTBase64urlEncode($pkey)));
		return $data;
	}
