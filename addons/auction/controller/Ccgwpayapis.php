 ...
 * 微信支付控制器
 */
class Ccgwpayapis extends Controller{
	...
	public function initialize() {
		...
		$this->payConfig['notifyurl'] = addon_url("auction://ccgwpayapis/ccgwNotify","",true,true);
	...
	public function getBtc(){
		...
		if($payObj=="bao"){
			$auction = $am->getUserAuction($auctionId, $userId);
	...
	public function getPayStatus() {
		...
		$obj = array();
		$obj["userId"] = model("app/users")->getUserId();
