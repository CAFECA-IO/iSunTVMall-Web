            ...
            var opts = {
			    ...
			    callback: function(data){
			    	if(data.last>0){
						...
						html.push("<span>"+data.hour+"</span>"+WST.lang('auction_hour')+"<span>"+data.mini+"</span>"+WST.lang('auction_minute')+"<span>"+data.sec+"</span>"+WST.lang('auction_second'));
			    		...
			    		var opts2 = {
						    ...
						    callback: function(data2){
						    	if(data2.last>0){
							    	...
							    	html.push("<span>"+data2.hour+"</span>"+WST.lang('auction_hour')+"<span>"+data2.mini+"</span>"+WST.lang('auction_minute')+"<span>"+data2.sec+"</span>"+WST.lang('auction_second'));
