...
class Kuaidi extends Base{
    ...
    public function getExpressName($expressId){
	    $rs = Db::name('express')->alias('e')
            ->join('__EXPRESS_LANGS__ el','el.expressId=e.expressId and el.langId='.WSTCurrLang())
            ->field('el.expressName')->where('e.expressId','=',$expressId)->find();
        return $rs;
    }
	...
	public function getExpressState($state){
		$stateTxt = "";
		switch ($state) {
			case '0':$stateTxt=lang('kuaidi_express_state_0');break;
			case '1':$stateTxt=lang('kuaidi_express_state_1');break;
			case '2':$stateTxt=lang('kuaidi_express_state_2');break;
			case '3':$stateTxt=lang('kuaidi_express_state_3');break;
			case '4':$stateTxt=lang('kuaidi_express_state_4');break;
			case '5':$stateTxt=lang('kuaidi_express_state_5');break;
			case '6':$stateTxt=lang('kuaidi_express_state_6');break;
			default:$stateTxt=lang('kuaidi_express_state_7');break;
		}
		return $stateTxt;
	}
