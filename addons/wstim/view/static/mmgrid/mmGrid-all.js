...
!function($){
    ...
    MMGrid.prototype = {
        ...
        , _initOptions: function(){
            ...
            if(cols){
                var bbHtml = ['<h1>'+WST.lang('wstim_plug_tips1')+'</h1>'];
                for(var colIndex=0; colIndex<cols.length; colIndex++){
                    bbHtml.push('<label ');
                    ...
                    if(col.title){
                        ...
                        bbHtml.push(WST.lang('wstim_plug_tips2'));
                    }
    ...
    $.fn.mmGrid.defaults = {
        ...
        , sortName: ''
        , sortStatus: 'asc'
        , loadingText: WST.lang('wstim_loading')
        , noDataText: WST.lang('wstim_no_data_available')
        , loadErrorText: WST.lang('wstim_tip39')
        , multiSelect: false
        , checkCol: false
        , indexCol: false
        , indexColWidth: 40
...
!function($){
    ...
    $.fn.mmPaginator.defaults = {
        ...
        , limitLabel: WST.lang('wstim_plug_tips3')
        , totalCountLabel: WST.lang('wstim_plug_tips4')
        , limit: undefined
