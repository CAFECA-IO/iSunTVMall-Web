 ...
 */
/**
 * 首页自定义页面取出正在进行中的营销活动组件
 */
function custom_page_marketing_data($id,$type){
    $sc = new \addons\custompage\model\CustomPageDecoration;
...
/**
 * 首页自定义页面取出正在进行中的优惠券组件
 */
function custom_page_coupon_data($id){
    $sc = new \addons\custompage\model\CustomPageDecoration;
