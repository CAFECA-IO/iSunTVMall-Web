...
function goodsList(){
    ...
    $.post(WST.AU('presale://goods/glists'), param,function(data){
...
function goGoods(id){
    location.href=WST.AU('presale://goods/modetail','id='+id);
}
function searchGoods(){
	var data = $('#wst-search').val();
	location.href = WST.AU('presale://goods/molists','keyword='+data);
}
//弹框
function dataShow(){
