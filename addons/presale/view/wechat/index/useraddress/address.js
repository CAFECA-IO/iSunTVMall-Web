        ...
        if( json.status == 1 ){
            ...
            setTimeout(function(){
            	if(param.addressId==0 && type==1){
            		...
            		location.href = WST.AU('presale://useraddress/wxindex','type='+type+'&addressId='+id);
            	}
            },1500);
        }else{
...
function inDefault(obj,id){
    ...
    $.post(WST.U('wechat/useraddress/setDefault'), {id:id}, function(data){
        ...
        if( json.status == 1 ){
        	WST.msg(json.msg,'success');
            setTimeout(function(){
            	location.href = WST.AU('presale://useraddress/wxindex');
            },1500);
        }else{
        	WST.msg(json.msg,'warn');
...
function chooseAddress(id){
	location.href = WST.AU('presale://carts/wxSettlement','addressId='+id);
}
