 ...
 * 微信支付控制器
 */
class Ccgwpays extends Controller{
	...
	public function initialize() {
		...
		$this->payConfig['notifyurl'] = addon_url("presale://ccgwpays/ccgwNotify","",true,true);
	...
	public function getCcgwPaysURL(){
		...
		$data["url"] = addon_url('presale://ccgwpays/createQrcode',array("pkey"=>WSTBase64urlEncode($pkey)));
		return $data;
	}
