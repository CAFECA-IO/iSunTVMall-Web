...
function editAddress(addressId){
    ...
    if(addressId>0){
    	...
    	$('#header-title').html(WST.lang('group_add_address'));
    }
    switchPage(1);
}
...
function saveAddress(addressId){
    ...
    if(userName==''){
    	WST.msg(WST.lang('group_require_consignee'),'info');
        return false;
    }
    if(userPhone==''){
    	WST.msg(WST.lang('group_require_contact_number'),'info');
        return false;
    }
    if(areaId==''){
    	WST.msg(WST.lang('group_please_select_area'),'info');
        return false;
    }
    if(userAddress==''){
    	WST.msg(WST.lang('group_require_detail_address'),'info');
        return false;
    }
    var param = {};
...
function delAddress(addressId){
	WST.dialog(WST.lang('group_confirm_del'),'toDelAddress('+addressId+')');
}
//删除收货地址
