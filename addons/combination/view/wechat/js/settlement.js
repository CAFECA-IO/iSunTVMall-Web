		      ...
		      setTimeout(function(){
		    	  if(param.payType==1){
		    		  if(param.payCode=='weixinpays' || param.payCode==''){
		    			  location.href = WST.U('wechat/weixinpays/toWeixinPay',{"pkey":json.pkey});
...
function addAddress(type,id){
	...
	location.href = WST.AU('combination://useraddress/weindex','type='+type+'&addressId='+id+'&combineKey='+$('#combineKey').val());
}
