        ...
        if( json.status == 1 ){
            ...
            setTimeout(function(){
            	if(param.addressId==0 && type==1){
            		...
            		location.href = WST.AU('combination://useraddress/weindex','type='+type+'&addressId='+id+'&id='+$('#combineKey').val());
            	}
            },1500);
        }else{
...
function inDefault(obj,id){
    ...
    $.post(WST.U('wechat/useraddress/setDefault'), {id:id}, function(data){
        ...
        if( json.status == 1 ){
        	WST.msg(json.msg,'success');
            setTimeout(function(){
            	location.href = WST.AU('combination://useraddress/weindex','id='+$('#combineKey').val());
            },1500);
        }else{
        	WST.msg(json.msg,'warn');
...
function chooseAddress(id){
	location.href = WST.AU('combination://carts/wxSettlement','addressId='+id+'&id='+$('#combineKey').val());
}
