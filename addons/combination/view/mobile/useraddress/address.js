        ...
        if( json.status == 1 ){
            ...
            setTimeout(function(){
            	if(param.addressId==0 && type==1){
            		...
            		location.href = WST.AU('combination://useraddress/moindex','type='+type+'&addressId='+id+'&id='+$('#combineKey').val());
            	}
            },1500);
        }else{
...
function inDefault(obj,id){
    ...
    $.post(WST.U('mobile/useraddress/setDefault'), {id:id}, function(data){
        ...
        if( json.status == 1 ){
        	WST.msg(json.msg,'success');
            setTimeout(function(){
            	location.href = WST.AU('combination://useraddress/moindex','id='+$('#combineKey').val());
            },1500);
        }else{
        	WST.msg(json.msg,'warn');
...
function chooseAddress(id){
	location.href = WST.AU('combination://carts/moSettlement','addressId='+id+'&id='+$('#combineKey').val());
}
