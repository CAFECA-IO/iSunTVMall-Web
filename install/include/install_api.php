...
$db_charset = trim($_POST['db_charset'])?trim($_POST['db_charset']):'utf8';
$db_name = trim($_POST['db_name']);
$admin_name = trim($_POST['admin_name']);
$admin_password = trim($_POST['admin_password']);
$db_type = (int)trim($_POST['db_demo']);
$act = $_POST['act'];
@$db->connect($db_host,$db_port, $db_user, $db_pass, $db_name, DBCHARSET,$db_prefix,$db_charset);
if($act=='list'){
	$list = array();
