            ...
            <div class="content" style="padding: 14px 50px 14px 100px;width: 750px;">
                ...
                <table class="check-env">
                    <?php
                        ...
                        echo '<tr><td class="left">exif_read_data</td><td><span class="check'.$func_items['exif_read_data']['status'].'"></span>'.$func_items['exif_read_data']['current'].'</td></tr>';
                    ?>
                </table>
            </div>
            <div class='bottom'>
           ...
           <div class='content'>
              <div id='data_config'>
                 ...
                 <table class='check-env'>
                    ...
                    <tr>
                      <td width="130" align="right" class="item">数据库编码<span class='red'>*</span>：</td>
                      <td align="left">
                          <select id='db_charset' style='height:25px;'>
                             <option value='utf8'>utf8</option>
                             <option value='utf8mb4'>utf8mb4</option>
                          </select>
                          <span style='font-size: 13px;'>（MySQL5.6请选择utf8，MySQL5.7及以上请选择utf8mb4）</span>
                      </td>
                    </tr>
                    <tr>
