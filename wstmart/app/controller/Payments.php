...
class Payments extends Base{
     ...
     * @OA\Get(
     *     tags={"Payments"},
     *     path="/app/Payments/getPayments",
     *     summary="获取在线支付方式",
     *     description="获取在线支付方式",
     *     @OA\Response(
     *      response="200",
     *      description="返回数据",
     *          @OA\MediaType(
     ...
     *                         @OA\Items(ref="#/components/schemas/payments_response_schema"),
     *                     )
     *                 ),
     *              }
     *             )
     ...
     * @OA\Get(
     *     tags={"Payments"},
     *     path="/app/Payments/aliPay",
     *     summary="获取支付宝支付字符串",
     *     description="获取支付宝支付字符串",
     *     @OA\Parameter(ref="#/components/parameters/tokenId"),
     *     @OA\Parameter(name="isBatch", in="query", @OA\Schema(type="string"), required=true, description="【订单支付】1：批量支付 0：单订单支付"),
     *     @OA\Parameter(name="orderNo", in="query", @OA\Schema(type="string"), required=true, description="【订单支付】当isBatch为1时,传入orderunique；当isBatch为0时,传入orderNo"),
     *     @OA\Parameter(name="payObj", in="query", @OA\Schema(type="string"), required=true, description="【充值】'recharge' 固定值，用于钱包充值"),
     *     @OA\Parameter(name="needPay", in="query", @OA\Schema(type="number"), required=true, description="【充值】自定义充值金额"),
     *     @OA\Parameter(name="itemId", in="query", @OA\Schema(type="integer"), required=true, description="【充值】选择的充值项id"),
     *     @OA\Response(
     *      response="200",
     *      description="返回数据",
     *          @OA\MediaType(
     ...
     *                 @OA\Schema(ref="#/components/schemas/response_schema"),
     *                 @OA\Schema(
     *                     @OA\Property(property="data",type="string", description="支付字符串")
     *                 ),
     *              }
     *             )
     *          )
     ...
     * @OA\Get(
     *     tags={"Payments"},
     *     path="/app/Payments/weixinPay",
     *     summary="获取微信支付所需数据",
     *     description="获取微信支付所需数据",
     *     @OA\Parameter(ref="#/components/parameters/tokenId"),
     *     @OA\Parameter(name="isBatch", in="query", @OA\Schema(type="string"), required=true, description="【订单支付】1：批量支付 0：单订单支付"),
     *     @OA\Parameter(name="orderNo", in="query", @OA\Schema(type="string"), required=true, description="【订单支付】当isBatch为1时,传入orderunique；当isBatch为0时,传入orderNo"),
     *     @OA\Parameter(name="payObj", in="query", @OA\Schema(type="string"), required=true, description="【充值】'recharge' 固定值，用于钱包充值"),
     ...
     *                     @OA\Property(property="data",type="array",
     *                         @OA\Items(
     *                             @OA\Property(property="appid", type="string", description="应用Id"),
     *                             @OA\Property(property="partnerid", type="string", description="商家向财付通申请的商家id"),
     *                             @OA\Property(property="prepayid", type="string", description="预支付id"),
     *                             @OA\Property(property="package", type="string", description="Sign=WXPay 固定值,具体看微信APP支付文档"),
     *                             @OA\Property(property="noncestr", type="string", description="随机串，防重发"),
     *                             @OA\Property(property="timestamp", type="string", description="时间戳，防重发"),
     *                             @OA\Property(property="sign", type="string", description="商家根据微信开放平台文档对数据做的签名"),
     *                         ),
     *                     )
     *                 ),
     *              }
