 ...
 * 发票详情类
 */
class SupplierOrderInvoices extends Base{
    protected $table = 'wst_supplier_orders';
    ...
    public function toExport(){
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A1', lang("label_order_no"))->setCellValue('B1', lang("label_order_invoice_money"))->setCellValue('C1', lang("label_invoice_head"))->setCellValue('D1', lang("label_invoice_code"))
            ->setCellValue('E1', lang("create_time"));
    ...
    public function setByBatch(){
        ...
        try{
            $result = $this->alias('o')
                ->where([['o.supplierId','=',$supplierId],['o.orderId','in',$ids],['o.dataFlag','=',1],['o.orderStatus','not in','-1,-2']])
                ->update($data);
            if(false !== $result){
                Db::commit();
