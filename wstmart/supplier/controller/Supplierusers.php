...
use wstmart\supplier\model\SupplierUsers as M;
/**
 * ============================================================================
 * WSTMart多用户商城
...
class Supplierusers extends Base{
	...
	public function index(){
		...
		return $this->fetch("supplierusers/list");
	}
    ...
    */
    ...
    public function add(){
    	$m = new M();
    	$object = $m->getEModel('supplier_roles');
        $roles = model("SupplierRoles")->listQuery();
		$data = ['object'=>$object,"roles"=>$roles];
        $this->assign("p",(int)input("p"));
    	return $this->fetch('supplierusers/add',$data);
    }
    ...
    public function edit(){
        ...
        $data = ['object'=>$object,"roles"=>$roles];
        $this->assign("p",(int)input("p"));
    	return $this->fetch('supplierusers/edit',$data);
    }
    ...
    public function notify(){
        ...
        $this->assign("p",(int)input("p"));
        return $this->fetch("supplierusers/notify");
    }
