...
use wstmart\supplier\model\SupplierGoods as M;
/**
 * ============================================================================
 * WSTMart多用户商城
...
class Goods extends Base{
    ...
    public function add(){
        $m = new M();
        $this->assign("p",1);
        $object = $m->getEModel('supplier_goods');
        ...
        $supplierExpressList = model("SupplierExpress")->supplierExpressList();
        $this->assign("supplierExpressList",$supplierExpressList);
