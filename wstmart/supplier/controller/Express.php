...
use wstmart\supplier\model\SupplierExpress as M;
...
class Express extends Base{
    ...
    */
    ...
    public function index2(){
        ...
        $supplierExpress = $m->getSupplierExpressInfo($supplierExpressId);
        $this->assign('supplierExpressId',$supplierExpressId);
        $this->assign('p',(int)input('p'));
        $this->assign('supplierExpress',$supplierExpress);
    ...
    */
    ...
    public function edit(){
        ...
        if($id>0){
            ...
            $object = $m->getEModel('supplier_freight_template');

        }
        $object["pnames"] = implode(",", $pnames);
        $otherAreas = $m->getOtherAreas($id,$supplierExpressId);
