...
class OrderComplains extends Validate{
	...
	protected $message  =   [
		'complainType.in'   => '{%invalid_complaint_type}',
		'complainContent.require' => '{%complain_content_require}',
		'complainContent.length' => '{%complain_content_require2}',
		'respondContent.require'   => '{%complain_reponse_content_require}',
		'respondContent.length' => '{%complain_reponse_content_require2}'
	];
