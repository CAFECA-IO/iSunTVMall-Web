...
class GoodsAppraises extends Validate{
	...
	protected $message  =   [
		'goodsScore.between'   => '{%goods_score_between}',
		'serviceScore.between' => '{%goods_score_between}',
		'timeScore.between' => '{%goods_score_between}',
		'content.require'   => '{%goods_appraise_content_require}',
		'content.length'   => '{%goods_appraise_content_require2}'
	];
