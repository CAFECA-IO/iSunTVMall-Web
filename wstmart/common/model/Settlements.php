...
class Settlements extends Base{
    ...
    public function speedySettlement($orderId){
        ...
        if(empty($shops))return WSTReturn(lang('settlement_shop_not_exist'));
        $backMoney = 0;
        ...
        if($settlementId>0){
            ...
            if($order->payType==0){
                ...
                if($order->scoreMoney >0){
                    ...
                    $lm['dataSrc'] = 2;
                    $lm['remark'] = json_encode(['type'=>'lang_params','key'=>'settlement_back_score_money','params'=>[$settlementNo,$order->scoreMoney]]);
                    $lm['moneyType'] = 1;
                ...
                if($tmpBackMoney>0){
                    ...
                    $lm['dataId'] = $settlementId;
                    $lm['dataSrc'] = 2;
                    $lm['remark'] = json_encode(['type'=>'lang_params','key'=>'settlement_back_score_money','params'=>[$settlementNo,$tmpBackMoney]]);
                    $lm['moneyType'] = 1;
            ...
            if($order->commissionFee>0){
                ...
                $lm['dataId'] = $settlementId;
                $lm['dataSrc'] = 2;
                $lm['remark'] = json_encode(['type'=>'lang_params','key'=>'settlement_commission_fee_tips','params'=>[$settlementNo,$order->commissionFee]]);
                $lm['moneyType'] = 0;
