...
class OrderInvoices extends Base{
    ...
    public function toExport(){
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A1', lang('order_no'))->setCellValue('B1', lang('invoice_money'))->setCellValue('C1', lang('invoice_head'))->setCellValue('D1', lang('invoice_tax_number'))
