...
function initGrid(page){
    ...
    var cols = [
            ...
            {title:WST.lang('label_order_shop'), name:'shopName', width: 90,sortable:true},
            ...
            {title:WST.lang('label_order_payment_type'), name:'payType' , width: 30,sortable:true},
            ...
            {title:WST.lang('label_order_a_status'), name:'orderStatus', width: 30,sortable:true, renderer:function(val,item,rowIndex){
...
function showDetail(id){
    parent.showBox({title:WST.lang('label_order_view'),type:2,content:WST.U('admin/orders/view',{id:id,from:1}),area: ['1020px', '500px'],btn:[WST.lang('close')]});
}
function loadMore(){
    var h = WST.pageHeight();
