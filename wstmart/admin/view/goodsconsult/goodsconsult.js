...
function initGrid(p){
    ...
    var cols = [
            ...
            {title:WST.lang('label_goodsappraises_goods'), name:'goodsName', width: 100,renderer: function(val,item,rowIndex){
            ...
            {title:WST.lang('label_goodsconsult_status'), name:'isShow', width: 100, renderer: function(val,item,rowIndex){
            ...
            {title:WST.lang('op'), name:'' ,width:70, align:'center', renderer: function(val,item,rowIndex){
                var h = "";
	            if(WST.GRANT.SPZX_02)h += "<a class='btn btn-blue' href='"+WST.U('admin/goodsconsult/toEdit','id='+item['id'])+'&p='+WST_CURR_PAGE+"'><i class='fa fa-pencil'></i>"+WST.lang('edit')+"</a> ";
    ...
    $('#goodsconsultForm').validator({
            fields: {
                consultContent: {
                  ...
                  msg:{length:WST.lang('require_goodsconsult_content1'),required:WST.lang('goodsconsult_tips1')},
