            ...
            for (var e = 0; e < menus.length; e++) {
                if (menus[e]["child"] && menus[e]["child"].length) {
                        ...
                        if (menus[e]["child"][d]["child"] && menus[e]["child"][d]["child"].length) {
                            for (var c = 0; c < menus[e]["child"][d]["child"].length; c++) {
                                if (menus[e]["child"][d]["child"][c]["child"] && menus[e]["child"][d]["child"][c]["child"].length) {
                                    for (var b = 0; b < menus[e]["child"][d]["child"][c]["child"].length; b++) {
                                        if (menus[e]["child"][d]["child"][c]["child"][b]["menuId"] == h) {
                                            g.push(WST.TransLang(menus[e]["child"][d]["child"][c]["child"][b]["menuName"]));
                                ...
                                if (menus[e]["child"][d]["child"][c]["menuId"] == h) {
                                    g.push(WST.TransLang(menus[e]["child"][d]["child"][c]["menuName"]));
                                    f = menus[e]["child"][d];
                                    break
                                }
                            }
                            if (g.length > 0 && f["menuId"] == menus[e]["child"][d]["menuId"]) {
                                g.push(WST.TransLang(menus[e]["child"][d]["menuName"]));
                                f = menus[e];
                                break
                            }
                        }
                    ...
                    if (g.length > 0 && f["menuId"] == menus[e]["menuId"]) {
                        g.push(WST.TransLang(menus[e]["menuName"]));
                        f = menus[e];
                        break
                    }
                }
...
function clearCache() {
    var a = WST.msg(WST.lang('clear_caceh_loading'), {
        icon: 16,
        time: 60000,
        offset: "200px"
    });
