...
function initGrid(p){
    ...
    var cols = [
            ...
            {title:WST.lang('label_goodsappraises_goods'), name:'goodsName',sortable: true, width: 100,renderer: function(val,item,rowIndex){
                return "<span  ><p class='wst-nowrap'>"+item['goodsName']+"</p></span>";
            }},
            
            {title:WST.lang('label_goodsappraises_score'), name:'goodsScore',sortable: true, width: 80, renderer: function(val,item,rowIndex){
            ...
            {title:WST.lang('label_goodsappraises_status'), name:'isShow', width: 20,sortable: true, renderer: function(val,item,rowIndex){
            ...
            {title:WST.lang('op'), name:'' ,width:95, align:'center', renderer: function(val,item,rowIndex){
                var h = "";
	            if(WST.GRANT.PJGL_02)h += "<a class='btn btn-blue' href='"+WST.U('admin/goodsappraises/toEdit','id='+item['id'])+'&p='+WST_CURR_PAGE+"'><i class='fa fa-pencil'></i>"+WST.lang('edit')+"</a> ";
