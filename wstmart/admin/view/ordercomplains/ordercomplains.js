...
function showDetail(id){
    parent.showBox({title:WST.lang('label_ordercomplains_order_view'),type:2,content:WST.U('admin/orderComplains/view',{cid:id,from:1}),area: ['1020px', '500px'],btn:[WST.lang('close')]});
}
