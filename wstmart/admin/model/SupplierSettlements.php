...
class SupplierSettlements extends Base{
   ...
   public function pageSupplierOrderQuery(){
    ...
    public function toExport(){
        ...
        ->setCellValue('B1', lang('label_supp_settlement_name'))->setCellValue('C1', lang('label_finance_seltment_money'))
        ...
        for ($row = 0; $row < count($page); $row++){
            ...
            ->setCellValue('B'.$i, $page[$row]['supplierName'])->setCellValue('C'.$i, lang('currency_symbol').$page[$row]['settlementMoney'])
