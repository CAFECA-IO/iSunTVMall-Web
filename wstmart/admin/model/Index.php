...
class Index extends Base{
	...
	public function summary(){
        ...
        $ydata = WSTCache('WST_ADMIN_MAIN'.$yesterday);
        if(!$ydata){
        	$ydata = [];
            ...
            WSTCache('WST_ADMIN_MAIN'.$yesterday,$ydata,86400);
        }
        ...
        //商品审核
        $data['tips']['goodsAudit'] = Db::name('goods')->where([['dataFlag','=',1],['goodsStatus','=',0],['isSale','=',1]])->count();
        //提现申请
        ...
        //订单投诉
        $data['tips']['complains'] = Db::name('order_complains')->where([['complainStatus','in',[0,3]]])->count();
        //商品举报
