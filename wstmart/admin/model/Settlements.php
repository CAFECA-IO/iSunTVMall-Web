...
class Settlements extends Base{
   ...
   public function pageShopOrderQuery(){
    ...
    public function toExport(){
        ...
        ->setKeywords(lang('settlements_excel1'));
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A1', lang('label_finance_seltment_no'))
        ->setCellValue('B1', lang('label_finance_seltment_apply_shop'))->setCellValue('C1', lang('label_finance_seltment_money'))
        ->setCellValue('D1', lang('label_finance_seltment_fee'))->setCellValue('E1', lang('label_supp_settlement_back_money'))
        ->setCellValue('F1', lang('brand_apply_shop_time'))->setCellValue('G1', lang('label_supp_settlement_status'));
        ...
        for ($row = 0; $row < count($page); $row++){
            ...
            ->setCellValue('B'.$i, $page[$row]['shopName'])->setCellValue('C'.$i, lang('currency_symbol').$page[$row]['settlementMoney'])
            ->setCellValue('D'.$i, lang('currency_symbol').$page[$row]['commissionFee'])->setCellValue('E'.$i, lang('currency_symbol').$page[$row]['backMoney'])
            ->setCellValue('F'.$i, $page[$row]['createTime'])->setCellValue('G'.$i, $page[$row]['settlementStatus']==1?lang('supp_settlement_yes_settle'):lang('supp_settlement_no_settle'));
        }
