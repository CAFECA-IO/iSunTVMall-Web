...
class ArticleCats extends Validate{
    ...
    protected $message = [
        'langParams.checkLangs' => '{%require_article_cat_name}',
    ...
    function checkLangs(){
       ...
       foreach ($langs as $key => $v) {
           if(!isset($langParams[$v['id']]) || !isset($langParams[$v['id']]['catName'])  || $langParams[$v['id']]['catName']=='')return lang('require_article_cat_name');
       }
       return true;
    }
    protected $scene = [
