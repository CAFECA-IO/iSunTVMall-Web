...
class ShopApplys extends Validate{
    ...
    function checkShopName(){
       ...
       if($applyStatus==1 && $shopName=='')return lang('please_enter_the_store_name');
       return true;
    }
    /**
     * 检测申请失败原因
    ...
    function checkStatus(){
       ...
       if($applyStatus==-1 && $handleReamrk=='')return lang('please_enter_the_reason_for_not_passing_the_audit');
       return true;
    }
    protected $scene = [
