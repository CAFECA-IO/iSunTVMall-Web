...
class Orderservices extends Base{
    ...
    */
    public function apply(){
        ...
        // 是否为固定搭配订单
        $isFixedCombination = $m->isFixedCombination($data['orderId']);
        $this->assign(["isFixedCombination"=>$isFixedCombination, 'goods'=>$goods, 'reasons'=>$reasons, 'orderId'=>(int)input('orderId'), 'goodsType'=>$goodsType]);
