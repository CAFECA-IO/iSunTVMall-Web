function initStep2(businessAreaPath,shopAreaIdPath,longitude,latitude,mapLevel){
    ...
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#legalCertificateImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		});
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#businessLicenceImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		});
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#bankAccountPermitImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		});
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#organizationCodeImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		});
...
function initStep3(areaPath){
	...
	var uploader = WST.upload({
			  ...
			  progress:function(rate){
			      $('#taxRegistrationCertificateImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		});
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#taxpayerQualificationImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		}); 
}
...
function initStep4(){
    WST.upload({
			  ...
			  progress:function(rate){
			      $('#shopImgMsg').show().html(WST.lang('has_upload')+rate+"%");
			  }
		}); 
