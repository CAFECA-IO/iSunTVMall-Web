            ...
            valid: function(form){
              ...
              $.post(WST.U('home/goodsAppraises/add'),params,function(data,dataStatus){
                ...
                if(json.status==1){
                   ...
                   var html = '<div class="appraise-area"><div class="appraise-item"><div class="appraise-title">'+WST.lang('goods_score')+'：</div>';
                       ...
                       html +='</div></div><div class="wst-clear"></div><div class="appraise-item"><div class="appraise-title">'+WST.lang('appraise_content')+'：</div>';
                       // 评价内容
                       html +='<div class="appraise-content">';
                        // 获取当前年月日
                       var  oDate = new Date();
