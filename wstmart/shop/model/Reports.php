...
class Reports extends CReports{
    ...
    public function getTopSaleGoods($sId=0){
        ...
        $rs = Db::table($prefix.'order_goods')->alias([$prefix.'order_goods'=>'og',$prefix.'orders'=>'o',$prefix.'goods'=>'g',$prefix.'goods_langs'=>'gl'])
    ...
    public function toExportTopSaleGoods(){
        ...
        ->setCellValue('A1', lang('goods_name'))
        ->setCellValue('B1', lang('goods_number'))
        ->setCellValue('C1', lang('sales_volume'));
    ...
    public function toExportStatSales(){
        ...
        ->setCellValue('B1', lang('number_of_orders'))
        ->setCellValue('C1', lang('sales_volume'));
        $objPHPExcel->getActiveSheet()->getStyle('A1:C1')->applyFromArray($styleArray);
        $i = 1;
        $totalRow = 0;
    ...
    public function toExportStatOrders(){
        ...
        $objPHPExcel->getActiveSheet()
        ->setCellValue('A1', lang('date'))
        ->setCellValue('B1', lang('order_to_be_paid'))
        ->setCellValue('C1', lang('cancellation_of_order'))
        ->setCellValue('D1', lang('reject_order'))
        ->setCellValue('E1', lang('normal_order'))
        ->setCellValue('F1', lang('total_order'));
