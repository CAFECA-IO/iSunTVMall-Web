...
function queryByPage(){
    ...
    var cols = [
        ...
        {title:WST.lang('scoring_information'), name:'', width: 100,renderer:function(val,item,rowIndex){
        ...
        {title:WST.lang('service_score'), name:'', width: 100,renderer:function(val,item,rowIndex){
        ...
        {title:WST.lang('timeliness_score'), name:'', width: 30,renderer:function(val,item,rowIndex){
        ...
        {title:WST.lang('reply'), name:'', width: 300,renderer:function(val,item,rowIndex){
                var html="";
                html+= WST.lang('evaluate')+[item['loginName']]+"："+item['content'];
