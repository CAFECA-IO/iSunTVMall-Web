...
require_once dirname ( __FILE__ ) . '/../../aop/request/AlipayTradeCancelRequest.php' ;
require_once dirname ( __FILE__ ) . '/../../aop/request/AlipayTradeQueryRequest.php' ;
require_once dirname ( __FILE__ ) . '/../../aop/request/AlipayTradePrecreateRequest.php' ;
require_once dirname ( __FILE__ ) . '/../../aop/request/AlipayTradeRefundRequest.php' ;
require_once dirname ( __FILE__ ) . '/../../aop/request/AlipayTradePayRequest.php' ;
                    
require_once dirname ( __FILE__ ).'/../model/result/AlipayF2FPayResult.php';
require_once dirname ( __FILE__ ).'/../model/result/AlipayF2FQueryResult.php';
require_once dirname ( __FILE__ ).'/../model/result/AlipayF2FRefundResult.php';
require_once dirname ( __FILE__ ).'/../model/result/AlipayF2FPrecreateResult.php';
require_once dirname ( __FILE__ ).'/../model/builder/AlipayTradeQueryContentBuilder.php';
require_once dirname ( __FILE__ ).'/../model/builder/AlipayTradeCancelContentBuilder.php';
